<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Appointment.aspx.cs" Inherits="asp.netloginpage.Appointment" %>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="Appointment.aspx" class="menu-item active">
    ...
    <span class="menu-text">Receptionist</span>
        ...
        <div class="main-content">
            <form id="form1" runat="server">
                ...
                <asp:Button ID="btnUpdate" runat="server" Text="Update Appointment" CssClass="btn btn-warning ms-2" OnClick="btnUpdate_Click" Visible="false" />
                <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn btn-secondary ms-2" OnClick="btnClear_Click" />

                <hr />
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered mt-3" AutoGenerateColumns="False"
                    OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="AppointmentID">
                    <Columns>
                ...
                <asp:Button ID="btnBack" runat="server" Text="Back to Home" CssClass="btn btn-dark" PostBackUrl="~/Default.aspx" />
            </form>
        </div>
    </div>
</body>
